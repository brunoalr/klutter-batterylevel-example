...
@interface PlatformBatteryLevel : PlatformBase
...
@property (readonly) PlatformFloat * _Nullable level __attribute__((swift_name("level")));
@end;
...
- (PlatformDouble * _Nullable)getBatteryLevelContext:(id)context __attribute__((swift_name("getBatteryLevel(context:)")));
@end;
